...
export default class Aspect {
    ...
    constructor(name, hexColor, components = []) {
        ...
        this.texturePath = `thaumcraft-research-minigame/assets/aspects/${name}.png`;
        ...
        Aspect.aspectDict[this.aspectName] = this; //add this object to the aspect Dictionary
    }
    ...
    static AURA = new Aspect("auram", 0xffc0ff, [Aspect.MAGIC, Aspect.AIR]);
    ...
    static BEAST = new Aspect("bestia", 0x9f6409, [Aspect.MOTION, Aspect.LIFE]);
