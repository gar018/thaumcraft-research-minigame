...
import TooltipTextObject from "./TooltipTextObject.js";
...
export default class AspectSceneObject extends SceneObject {
    ...
    async createGeometry() {
        ...
        try {await this.aspectImage.decode();}
            ...
            this.aspectImage.src = "/thaumcraft-research-minigame/assets/aspects/_unknown.png";
    ...
    async createShaders() {
        let shaderCode = await this.loadShader("/thaumcraft-research-minigame/shaders/aspect.wgsl");
