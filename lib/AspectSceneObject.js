...
export default class AspectSceneObject extends SceneObject {
    constructor(device, canvasFormat, aspect, pose) {
        super(device, canvasFormat); //TODO refactor device and canvasFormat to be already defined statically in SceneObject
