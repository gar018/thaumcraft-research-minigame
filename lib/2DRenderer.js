...
export default class Renderer {
  constructor(canvas) {
    this._canvas = canvas;
    this._objects = [];
    this._clearColor = { r: 0, g: 0/255, b: 0/255, a: 1 }; // Black background
    //this._clearColor = {r: 1, g: 0, b: 1, a: 1}; // magenta background
  }
  ...
  resizeCanvas() {
    ...
    const width = 512;//window.innerWidth * devicePixelRatio;
    const height = 512;//window.innerHeight * devicePixelRatio;
