...
export default class ScrollObject extends SceneObject {
    ...
    static scriptPath = "/thaumcraft-research-minigame/assets/script.png"
    static parchmentPath = "/thaumcraft-research-minigame/assets/parchment3.png" //texture needs to get bitmap width and height adjusted during createGeometry
    ...
    async createGeometry() {
        try {await this.parchment.decode();}
            ...
            this.parchment.src = "/thaumcraft-research-minigame/assets/aspects/_unknown.png";
    ...
    async createShaders() {
        let shaderCode = await this.loadShader("/thaumcraft-research-minigame/shaders/scroll.wgsl");
